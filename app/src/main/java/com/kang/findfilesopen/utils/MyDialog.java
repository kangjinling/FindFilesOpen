...
public class MyDialog {
    ...
    public static EditText txt_edite;
    ...
    public MyDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.dialog_alertdialog, null);
        ...
        txt_edite = (EditText) view.findViewById(R.id.txt_edite);
        txt_edite.setVisibility(View.GONE);
    ...
    private void setLayout() {
        ...
        if (showEdt) {
            txt_edite.setVisibility(View.VISIBLE);
        }
